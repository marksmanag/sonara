SONARA PROJECT EXECUTION CONTRACT

Phase 1 — Constitutional Repository Foundation

This instruction supersedes previous incremental correction messages for the current "docs/constitution-spec" branch.

Treat this as an authoritative engineering instruction for the current task.

The objective is not merely to produce a clean-looking diff. The objective is to establish a verified, trustworthy, version-controlled foundation for Sonara that can remain reliable for the lifetime of the project.
...
SONARA CONSTITUTION
       │
       ▼
Repository Constitutional Copy
       │
       ├── Research
...
The Constitution is the governing source of product-development principles.

The repository copy is the version-controlled engineering representation of that Constitution.

Engineering decisions, ADRs, requirements, architecture, and implementation must remain consistent with it.

Code must not silently redefine the Constitution.

If implementation appears to conflict with the Constitution:

1. stop,
2. document the conflict,
3. resolve the governing decision,
...
2. SONARA CONSTITUTION

The following is the authoritative constitutional blueprint for this branch.

Create/maintain:

"docs/constitution/README.md"

The document must contain all sections 1 through 30.

Do not replace sections with summaries, placeholders, ellipses, or statements such as:

"... (remaining sections preserved in same spirit) ..."

Do not invent missing constitutional material.

Do not reconstruct constitutional language from memory.

Use the following complete specification as the source text:
